...
<body>
    ...
    <div class = "content">
        ...
        <div class="list">
            ...
            <input type="button" value="작성 완료" class="btn btn-info" style="margin-bottom: 1.5%; margin-left: 50%;" onclick="location.href='http://127.0.0.1:5500/front/HyunWoo/calendar.html';">
            <hr>
