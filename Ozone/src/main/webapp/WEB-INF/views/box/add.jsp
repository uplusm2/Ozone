...
<body>
    ...
    <div class = "container">
        ...
        <div class>
            <div class = "tle title-add">파일 등록</div>
            <br>
            <table class = "add-table">
                <tr>
                    <th>제목</th>
                    <td><input type="text" class = "add-title" placeholder="제목을 입력해주세요"></td>
                </tr>
                <tr>
                    <th>내용</th>
                    <td><textarea class = "add-content" placeholder="내용을 입력해주세요"></textarea></td>
                </tr>
                <tr>
                    <th>파일</th>
                    <td><input type = "file" class = "add-file"></td>
                </tr>
            </table>
            <div class = "btncon">
                <input type = "button"class = "btn btn-add" value = "등록" onclick="location.href='boxadd'">
                <input type = "button" class =  "btn btn-cancel" value = "취소" onclick="history.back()">
            </div>
