...
<body>
    ...
    <div class = "container">
       ...
       <div class>
            ...
            <div class = "btncon">
                <input type = "button" class = "btn btn-share" value = "비공개" onclick="location.href='unsharecheck.jsp'">
                <input type = "button" class = "btn btn-delete" value = "삭제" onclick="location.href='del.jsp'">
            </div>
